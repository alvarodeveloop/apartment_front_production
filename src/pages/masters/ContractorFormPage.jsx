...
const ContractorFormPage = (props) => {
  ...
  const fetchData = () => {
    ...
    if(props.match.params.id){
      axios.get(API_URL+'master_contractor/'+props.match.params.id).then(result => {
  ...
  const handleSubmit = e => {
    ...
    if(objectPost.id){
      axios.put(API_URL+'master_contractor/'+objectPost.id,objectPost).then(result => {
  ...
  const gotBackToTable = () => {
    props.history.replace('/masters/contractor')
  }
...
ContractorFormPage.defaultProps = {
  inputRut: {
    type: 'text',
    required: true,
    name: 'rut',
