...
const ParamsServiceTypeServicePage = (props) => {
  ...
  const confirmDeleteRegister = id => {
    axios.delete(API_URL+'params_service_type_service/'+id).then(result => {
  ...
  const fetchData = () => {
    axios.get(API_URL+'params_service_type_service').then(result => {
  ...
  const onSubmit = e => {
    ...
    if(objectPost.id){
      axios.put(API_URL+'params_service_type_service/'+objectPost.id,objectPost).then(result => {
      ...
      axios.post(API_URL+'params_service_type_service',objectPost).then(result => {
    ...
    <Container>
      <Row className="containerDiv">
        <Col sm={12} md={12} lg={12} xs={12} className="">
          <h4 className="title_principal">Tipo de Servicios</h4>
          <hr/>
        </Col>
...
ParamsServiceTypeServicePage.defaultProps = {
  inputName: {
    type: 'text',
    required: true,
    name: 'name',
...
export default ParamsServiceTypeServicePage
