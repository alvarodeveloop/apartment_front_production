...
const TableTaskAreaComponent = (props) => {
        ...
        Cell: props1 => {
          ...
          return (
            <DropdownButton id={'drop'+original.id} title="Seleccione"  block="true" size="sm">
              ...
              <Dropdown.Item onClick={() => showSS(original.id_area_ss) }>Ver S.S</Dropdown.Item>
            </DropdownButton>
          )
        }
      },
...
TableTaskAreaComponent.propTypes = {
  data : PropTypes.array.isRequired,
  history: PropTypes.object.isRequired,
  type: PropTypes.string,
}

export default TableTaskAreaComponent
